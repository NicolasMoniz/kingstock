...
(lib.Symbole3 = function(mode,startPosition,loop) {
	...
	// Calque 1
	this.text = new cjs.Text("Cette page n'existe pas", "20px 'Franklin Gothic Heavy'", "#535354");
...
(lib.Symbole2 = function(mode,startPosition,loop) {
	...
	// Calque 1
	this.text = new cjs.Text("Erreur 404", "40px 'Franklin Gothic Heavy'", "#535354");
	this.text.textAlign = "center";
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"http://king-stock.fr/source/images/nuages.png", id:"nuages"}
	],
	preloads: []
};
